...
export function CalendarPage({ today, onChooseDay }: Props) {
  ...
  return <main className="page calendar-page">
    <header className="section-title"><h1>Calendar</h1><p>A dot means at least one exercise occurred.</p></header>
