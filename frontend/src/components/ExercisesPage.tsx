...
export function ExercisesPage() {
  ...
  return <main className="page exercises-page">
    <header className="section-title card-heading"><div><h1>Exercises</h1><p>Manage the exercise library and its defaults.</p></div><button className="primary" onClick={() => setCreating(true)}><Plus />New</button></header>
